<?php
// http://911digitalarchive.org/contribute.php?type=email
require_once 'Sept11/Import/Strategy/EmailsAbstract.php';

class Sept11_Import_Strategy_Sept11Emails extends Sept11_Import_Strategy_EmailsAbstract
{
    const COLLECTION_ID = 29;
